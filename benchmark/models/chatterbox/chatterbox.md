# Chatterbox Batch Audio Generator

This script generates speech audio using **Chatterbox**, supporting:
...
## Requirements
detailed setup on https://github.com/resemble-ai/chatterbox
